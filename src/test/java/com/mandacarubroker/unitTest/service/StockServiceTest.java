...
class StockServiceTest {
  ...
  void validateRequestStockDataTransferObject_ValidData_NoExceptionThrown() {
    ...
    assertDoesNotThrow(() -> StockService.validateRequestDataTransferObject(data));
  }
  ...
  void validateRequestStockDataTransferObject_InvalidData_ConstraintViolationExceptionThrown() {
    ...
    assertThrows(ConstraintViolationException.class, () -> StockService.validateRequestDataTransferObject(data));
  }
}
